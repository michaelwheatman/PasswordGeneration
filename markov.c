...
int main(int argc, char **argv)
{
	...
	for ( xFile = 2; xFile < argc; ++xFile )
	{
		...
		{
			if ( nGrams == 4 )
				fprintf(fpPCFG, "%c%c%c%c", 'a' + (i/(N_LETTERS*N_LETTERS*N_LETTERS)), 'a' + ((i/(N_LETTERS*N_LETTERS))%N_LETTERS), 'a' + ((i/N_LETTERS)%N_LETTERS), 'a' + (i%N_LETTERS));
			else if ( nGrams == 3 )
				fprintf(fpPCFG, "%c%c%c", 'a' + (i/(N_LETTERS*N_LETTERS)), 'a' + ((i/N_LETTERS)%N_LETTERS), 'a' + (i%N_LETTERS));
			else if ( nGrams == 2 )
				fprintf(fpPCFG, "%c%c", 'a' + i/N_LETTERS, 'a'+ (i%N_LETTERS));
			else
				fprintf(fpPCFG, "%c", 'a' + i);
		...
		{
			if ( nGrams == 4 )
				fprintf(fpMC, "%c%c%c%c", ' ' + (i/(N_CHARS*N_CHARS*N_CHARS)), ' ' + ((i/(N_CHARS*N_CHARS))%N_CHARS), ' ' + ((i/N_CHARS)%N_CHARS), ' ' + (i%N_CHARS));
			else if ( nGrams == 3 )
				fprintf(fpMC, "%c%c%c", ' ' + (i/(N_CHARS*N_CHARS)), ' ' + ((i/N_CHARS)%N_CHARS), ' ' + (i%N_CHARS));
			else if ( nGrams == 2 )
				fprintf(fpMC, "%c%c", ' ' + i/N_CHARS, ' '+ (i%N_CHARS));
			else
				fprintf(fpMC, "%c", ' ' + i);
